...
PlayerSection:NewSlider("Fly Speed", "Adjust fly speed (Toggle F)", 300, 50, function(val)
    flySpeed = val
end)

PlayerSection:NewButton("Enable Fly (Press F to Toggle)", "WASD to move", function()
